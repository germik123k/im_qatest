Feature: Subir Imagen de Perfil
  ...
  Scenario: Usuario sube su imagen de perfil correctamente
    ...
    Then el usuario espera 4 segundos
    And el usuario abre el modal de carga de imagen
    When el usuario hace click en la zona de carga de imagen
    Then el usuario espera 3 segundos
    And el usuario selecciona la imagen "img_test_.png" desde su escritorio
    Then el usuario espera 4 segundos
